...
namespace Generator.Parser
{
	...
	public abstract class TypeResolutionClass<TTypeEnum> : IResolveType<TTypeEnum>
	{
		...
		internal class SchemaNavigator
		{
			...
			public DataView ViewIndexes		{ get { return new DataView(ds.Tables[Strings.Schema_Indexes],"","",rs); } }
			public DataView ViewTables		{ get { return new DataView(ds.Tables[Strings.Schema_Tables],"","",rs); } }
			public DataView ViewColumns		{ get { return new DataView(ds.Tables[Strings.Schema_Columns],"","",rs); } }
			public DataView ViewDataTypes	{ get { return new DataView(ds.Tables[Strings.Schema_DataTypes],"","",rs); } }
