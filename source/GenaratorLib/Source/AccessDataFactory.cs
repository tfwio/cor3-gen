...
namespace Generator.Data
{
	public class AccessDataFactory : BasicDataFactory<OleDbConnection,OleDbCommand,OleDbDataAdapter,OleDbParameter>{
		...
		{
			TableToDataset(c,ds,Strings.Schema_Indexes);
			TableToDataset(c,ds,Strings.Schema_Tables);
			TableToDataset(c,ds,Strings.Schema_Views);
			TableToDataset(c,ds,Strings.Schema_Procedures);
			TableToDataset(c,ds,Strings.Schema_Columns);
			TableToDataset(c,ds,Strings.Schema_DataTypes);
			TableToDataset(c,ds,Strings.Schema_Restrictions);
			TableToDataset(c,ds,Strings.Schema_ReservedWords);
		}
